    ...
    <>
      <div class="p-6 pb-0">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
          <div class="bg-white/5 xl:max-h-[140px] rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
            <div class="flex justify-between mb-3">
              <div>
                <div class="flex items-center mb-1">
                  <div class="text-2xl text-white font-semibold">Level 2</div>
                </div>
                <div class="text-sm font-medium text-gray-400">180/293 XP</div>
              </div>
              <div class="dropdown">
            ...
            <progress className="rounded-lg" value={0.58} />
          </div>
          <div class="bg-white/5 xl:max-h-[140px] rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
            <div class="flex justify-between mb-4">
              <div>
                <div class="flex items-center mb-1">
                  <div class="text-2xl text-white font-semibold">100</div>
          ...
          <div class="bg-white/5 xl:max-h-[140px] rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
            <div class="flex justify-between mb-6">
              <div>
                <div class="text-2xl text-white font-semibold mb-1">100</div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          <div class="p-6 xl:max-h-[274px] relative flex flex-col min-w-0 mb-4 lg:mb-0 break-words border border-gray-100 bg-gray-50 dark:bg-gray-800 w-full shadow-lg rounded">
            <div class="rounded-t mb-0 px-0 border-0">
              <div class="flex flex-wrap items-center px-4 py-2">
                <div class="relative w-full max-w-full flex-grow flex-1">
                  <h3 class="font-semibold text-base text-gray-900 dark:text-gray-50">Achievements</h3>
                </div>
              </div>
              <div class="block w-full overflow-x-auto">
                <table class="items-center w-full bg-transparent border-collapse">
                  <thead>
                    <tr>
                      <th class="px-4 bg-gray-100 dark:bg-gray-900 text-gray-500 dark:text-gray-200 align-middle py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left rounded-tl-md rounded-bl-md">Role</th>
                      <th class="px-4 bg-gray-100 dark:bg-gray-900 text-gray-500 dark:text-gray-200 align-middle py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">Amount</th>
                      <th class="px-4 bg-gray-100 dark:bg-gray-900 text-gray-500 dark:text-gray-200 align-middle py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left rounded-tr-md rounded-br-md min-w-140-px"></th>
                    </tr>
                  </thead>
                  <tbody>
          ...
          <div class="bg-white/5 xl:max-h-[274px] border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
            <div class="flex justify-between mb-4 items-start">
              <div class="font-medium text-white">Quest Log</div>
              <div class="dropdown">
                <button type="button" class="dropdown-toggle text-gray-400 hover:text-gray-600"><i class="ri-more-fill"></i></button>
                <ul class="dropdown-menu shadow-md shadow-black/5 z-30 hidden py-1.5 rounded-md bg-white/5 border border-gray-100 w-full max-w-[140px]">
                  <li>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6 lg:mb-4">
          <div class="bg-white/5 border lg:max-h-[300px] lg:h-[300px] xl:max-h-[430px] xl:h-[430px] border-gray-100 shadow-md shadow-black/5 p-6 rounded-md lg:col-span-2">
            <div class="flex justify-between mb-4 items-start">
              <div class="font-medium text-white">Analytics</div>
              <div class="dropdown">
                <button type="button" class="dropdown-toggle text-gray-400 hover:text-gray-600"><i class="ri-more-fill"></i></button>
                <ul class="dropdown-menu shadow-md shadow-black/5 z-30 hidden py-1.5 rounded-md bg-white/5 border border-gray-100 w-full max-w-[140px]">
                  <li>
          ...
          <div class="bg-white/5 lg:max-h-[300px] lg:h-[300px] xl:max-h-[430px] xl:h-[430px] border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
            <div class="flex justify-between mb-4 items-start">
              <div class="font-medium text-white">Earnings</div>
              <div class="dropdown">
                <button type="button" class="dropdown-toggle text-gray-400 hover:text-gray-600"><i class="ri-more-fill"></i></button>
                <ul class="dropdown-menu shadow-md shadow-black/5 z-30 hidden py-1.5 rounded-md bg-white/5 border border-gray-100 w-full max-w-[140px]">
                  <li>
            ...
            <div class="overflow-x-auto">
              <table class="w-full min-w-[460px]">
                <thead>
                  <tr>
                    <th class="text-[12px] uppercase tracking-wide font-medium text-gray-200 py-2 px-4 bg-gray-900 text-left rounded-tl-md rounded-bl-md">Service</th>
                    <th class="text-[12px] uppercase tracking-wide font-medium text-gray-200 py-2 px-4 bg-gray-900 text-left">Earning</th>
                    <th class="text-[12px] uppercase tracking-wide font-medium text-gray-200 py-2 px-4 bg-gray-900 text-left rounded-tr-md rounded-br-md">Status</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                  ...
                  <tr className="lg:hidden xl:table-row">
                    <td class="py-2 px-4 border-b border-b-gray-50">
                      <div class="flex items-center">
                        <img src="https://placehold.co/32x32" alt="" class="w-8 h-8 rounded object-cover block" />
                        <a href="#" class="text-gray-600 text-sm font-medium hover:text-blue-500 ml-2 truncate">Create landing page</a>
